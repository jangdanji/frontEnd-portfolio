...
},{"buffer":"node_modules/buffer/index.js"}],"js/puzzleMaker.js":[function(require,module,exports) {
...
columnText.forEach(function (text) {
  for (var _i = 0; _i < text.word.length; _i++) {
    var target = document.querySelector(".puzzle-grid table tr:nth-child(".concat(text.row, ") td:nth-child(").concat(text.col + _i, ")"));
    target.textContent = text.word[_i];
    target.classList.add(text.word);
  }
});
rowText.forEach(function (text) {
  for (var _i2 = 0; _i2 < text.word.length; _i2++) {
    var target = document.querySelector(".puzzle-grid table tr:nth-child(".concat(text.row + _i2, ") td:nth-child(").concat(text.col, ")"));
    target.textContent = text.word[_i2];
    target.classList.add(text.word);
  }
});

/* 텍스트가 없는 부분 투명처리하기 */
var allTd = document.querySelectorAll('.puzzle-grid table td');
allTd.forEach(function (td) {
  if (td.textContent === '') td.style.border = 'none';else td.classList.add('word');
});
...
function findSolo(clickClass, allClass) {
  ...
  var notActive = _.find(clickClass, function (value) {
    return value !== active;
  }); /* 활성화 안된거 */
  ...
  td.addEventListener('click', function () {
    ...
    if ($(td).hasClass('active') && className.length > 1) {
      ...
      findActive.forEach(function (active) {
        var _activeTds;
        var classes = active.getAttribute('class').split(' ');
        (_activeTds = activeTds).push.apply(_activeTds, _toConsumableArray(classes));
      });
      activeTds = activeTds.filter(function (value) {
        return value !== 'active' && value !== 'word';
      });
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "6055" + '/');
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/puzzleMaker.js"], null)
//# sourceMappingURL=/puzzleMaker.7afe59cc.js.map