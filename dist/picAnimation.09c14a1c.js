...
},{"buffer":"node_modules/buffer/index.js"}],"js/picAnimation.js":[function(require,module,exports) {
...
var msgBackWrap = document.querySelector('.photo-back');

/* 메세지 뒷배경에 이미지 삽입 */
for (var _i = 1; _i < 4; _i++) {
  var _myImg = document.createElement('img');
  _myImg.setAttribute('src', "./img/img_0".concat(_i, ".jpg"));
  _myImg.style.filter = 'blur(25px) brightness(70%)';
  if (_i == 3) _myImg.classList.add('active');
  msgBackWrap.appendChild(_myImg);
}
...
/* 채워진 dot 만들기 */
var dots = document.querySelectorAll('.dots .fa-circle');
var dotCopyBox = document.createElement('div');
...
function introAnimate() {
  ...
  /* dots */
  var dots = document.querySelector('.dots.filled');
  var filled = dots.querySelector('.fa-circle[style*="opacity: 1"]');
  filled.style.opacity = '0';
  if (filled === dots.lastElementChild) dots.firstElementChild.style.opacity = '1';else filled.nextElementSibling.style.opacity = '1';
  ...
  gsap.to($('.profile-msg .motto div'), {
    ...
    onComplete: function onComplete() {
      ...
      var lastMotto = $('.profile-msg .motto div > p:last-child');
  ...
  /* 텍스트 뒷배경 */
  var backImg = document.querySelectorAll('.photo-back img');
...
var textMachine = document.querySelector('.profile-msg .motto');
